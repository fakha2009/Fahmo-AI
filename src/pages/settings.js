        ...
        <aside>
          <section class="card card--padded">
            ...
            <div class="settings-stack">
              <div class="data-item"><div class="data-item__type">${escapeHtml(t('version'))}</div><div class="data-item__value">${escapeHtml(globalThis.__FAHMO_CONFIG__?.appVersion ?? '1.1.1')}</div></div>
